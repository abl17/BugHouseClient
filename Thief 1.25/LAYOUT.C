...
void LAYOUT_Restore (int nN)
    ...
    if (IsWindow (hwnd))
        ...
        if (hwnd == hwndWindow [HWND_BUTTON])
            {
...
void LAYOUT_CreateDefaultLayout (int nW, int nH, int nW1, int nH1, int nOW, int nOH, int nI)
    ...
    switch (nI)
        {
        case 0 : LAYOUT_Load2 (nW, nH, nW1, nH1, nOW, nH1) ; break ;
        case 1 : LAYOUT_Load1 (nW, nH, nW1, nH1, nOW, nH1) ; break ;
        case 2 : LAYOUT_Load2 (nW, nH, nW1, nH1, nOW, nH1) ; break ;
        case 3 : LAYOUT_Load3 (nW, nH, nW1, nH1, nOW, nH1) ; break ;
        case 4 : LAYOUT_Load4 (nW, nH, nW1, nH1, nOW, nH1) ; break ;
        case 5 : LAYOUT_Load5 (nW, nH, nW1, nH1, nOW, nH1) ; break ;
        case 6 : LAYOUT_Load6 (nW, nH, nW1, nH1, nOW, nH1) ; break ;
        case 7 : LAYOUT_Load7 (nW, nH, nW1, nH1, nOW, nH1) ; break ;
        case 8 : LAYOUT_Load8 (nW, nH, nW1, nH1, nOW, nH1) ; break ;
        }
    }
