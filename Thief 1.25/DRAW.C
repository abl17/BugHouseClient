...
void DRAW_Piece (HDC hdc, int nPc)
    ...
    switch (nPc)
        {
        case WHITE_PAWN :   DRAW_PawnW (hdc) ;   return ;
        case BLACK_PAWN :   DRAW_PawnB (hdc) ;   return ;
        case WHITE_KNIGHT : DRAW_KnightW (hdc) ; return ;
        case BLACK_KNIGHT : DRAW_KnightB (hdc) ; return ;
        case WHITE_BISHOP : DRAW_BishopW (hdc) ; return ;
        case BLACK_BISHOP : DRAW_BishopB (hdc) ; return ;
        case WHITE_ROOK :   DRAW_RookW (hdc) ;   return ;
        case BLACK_ROOK :   DRAW_RookB (hdc) ;   return ;
        case WHITE_QUEEN :  DRAW_QueenW (hdc) ;  return ;
        case BLACK_QUEEN :  DRAW_QueenB (hdc) ;  return ;
        case WHITE_KING :   DRAW_KingW (hdc) ;   return ;
        case BLACK_KING :   DRAW_KingB (hdc) ;   return ;
        }
    }
...
void DRAW_Piece_Outline (HDC hdc, int nPc, COLORREF clrO)
    ...
    switch (nPc)
        {
        case WHITE_PAWN :   DRAW_PawnW_Outline   (hdc, clrO) ; return ;
        case BLACK_PAWN :   DRAW_PawnB_Outline   (hdc, clrO) ; return ;
        case WHITE_KNIGHT : DRAW_KnightW_Outline (hdc, clrO) ; return ;
        case BLACK_KNIGHT : DRAW_KnightB_Outline (hdc, clrO) ; return ;
        case WHITE_BISHOP : DRAW_BishopW_Outline (hdc, clrO) ; return ;
        case BLACK_BISHOP : DRAW_BishopB_Outline (hdc, clrO) ; return ;
        case WHITE_ROOK :   DRAW_RookW_Outline   (hdc, clrO) ; return ;
        case BLACK_ROOK :   DRAW_RookB_Outline   (hdc, clrO) ; return ;
        case WHITE_QUEEN :  DRAW_QueenW_Outline  (hdc, clrO) ; return ;
        case BLACK_QUEEN :  DRAW_QueenB_Outline  (hdc, clrO) ; return ;
        case WHITE_KING :   DRAW_KingW_Outline   (hdc, clrO) ; return ;
        case BLACK_KING :   DRAW_KingB_Outline   (hdc, clrO) ; return ;
        }
    }
...
void DRAW_Piece1 (HDC hdc, int nPc, COLORREF clrWP, COLORREF clrWB, COLORREF clrBP, COLORREF clrBB)
    ...
    switch (nPc)
        {
        case WHITE_PAWN :   DRAW_PawnW1 (hdc, clrWP, clrWB) ;   return ;
        case BLACK_PAWN :   DRAW_PawnB1 (hdc, clrBP, clrBB) ;   return ;
        case WHITE_KNIGHT : DRAW_KnightW1 (hdc, clrWP, clrWB) ; return ;
        case BLACK_KNIGHT : DRAW_KnightB1 (hdc, clrBP, clrBB) ; return ;
        case WHITE_BISHOP : DRAW_BishopW1 (hdc, clrWP, clrWB) ; return ;
        case BLACK_BISHOP : DRAW_BishopB1 (hdc, clrBP, clrBB) ; return ;
        case WHITE_ROOK :   DRAW_RookW1 (hdc, clrWP, clrWB) ;   return ;
        case BLACK_ROOK :   DRAW_RookB1 (hdc, clrBP, clrBB) ;   return ;
        case WHITE_QUEEN :  DRAW_QueenW1 (hdc, clrWP, clrWB) ;  return ;
        case BLACK_QUEEN :  DRAW_QueenB1 (hdc, clrBP, clrBB) ;  return ;
        case WHITE_KING :   DRAW_KingW1 (hdc, clrWP, clrWB) ;   return ;
        case BLACK_KING :   DRAW_KingB1 (hdc, clrBP, clrBB) ;   return ;
        }
    }
