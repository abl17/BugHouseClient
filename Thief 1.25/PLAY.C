...
LRESULT CALLBACK PlayWndProc (HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
    ...
    switch (iMsg)
        ...
        case WM_LBUTTONDOWN :
            ...
            if ((nMx >= Game [INDEX_PLAY].rBuffer.left   &&
        ...
        case WM_RBUTTONDOWN :
            ...
            if (PtInRect (&Game [INDEX_PLAY].rHandle [INDEX_BLACK], pt))
                {
                nJ = INDEX_BLACK ;
                }
            else
            ...
            if ((nJ == INDEX_WHITE) || (nJ == INDEX_BLACK))
                ...
                for (nI = 0 ; nI < MAX_RM_ITEM ; nI++)
                    ...
                    if (TOOLBOX_OKRightMouse (RIGHT_MOUSE_BOARD_HANDLE, nI))
                        {
                        if (nJ == 0)
                            {
                            System.nRightMouseIndex = RIGHT_MOUSE_BOARD_HANDLE ;
            ...
            if (Game [INDEX_PLAY].nGameNumber > 0)
                ...
                if ((Game [INDEX_PLAY].nGameType == GAMETYPE_BUGHOUSE  ) ||
                    ...
                    if (Game [INDEX_PLAY].bPlaying)
                        ...
                        if (User.bRightMousePlay && (Game [INDEX_PLAY].nGameType == GAMETYPE_CRAZYHOUSE))
                            {
                            //
            ...
            if (nK)
                ...
                for (nI = 0 ; nI < MAX_RM_ITEM ; nI++)
                    ...
                    if (TOOLBOX_OKRightMouse (RIGHT_MOUSE_PLAY, nI))
                        {
                        if (nJ == 0)
                            {
                            System.nRightMouseIndex = RIGHT_MOUSE_PLAY ;
        ...
        case WM_GETMINMAXINFO :
            if (User.bStopResizePlay)
                ...
                if (Game [INDEX_PLAY].nGameNumber > 0 && Game [INDEX_PLAY].bPlaying)
                    ...
                    if ((Game [INDEX_PLAY].nState == WIN_MAXIMIZE) || (IsZoomed (hwnd)))
                        {
                        mmi = (MINMAXINFO *) lParam ;
                        mmi->ptMinTrackSize.x  = 200 ;
                        mmi->ptMinTrackSize.y  = 200 ;
        ...
        if (Game [INDEX_PLAY].nMaxIndex == -2)
            ...
            switch (nB)
                ...
                case 1 :
                    ...
                    if (Game [INDEX_PLAY].nCurrentIndex == Game [INDEX_PLAY].nMinIndex)
                        {
                    ...
                    if (Game [INDEX_PLAY].nCurrentColor == 0)
                        {
                ...
                case 2 :
                    ...
                    if (Game [INDEX_PLAY].nCurrentIndex == -1)
                        {
                        Game [INDEX_PLAY].nCurrentIndex = Game [INDEX_PLAY].nMinIndex ;
            ...
            if (Game [INDEX_PLAY].nCurrentIndex < MAX_POSITION)
                {
                hdc = GetDC (Game [INDEX_PLAY].hwnd) ;
