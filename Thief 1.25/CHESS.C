...
void CHESS_Init (void)
    {
    _KnightMoveX [0] = +1 ;     _KnightMoveY [0] = +2 ;
    _KnightMoveX [1] = +2 ;     _KnightMoveY [1] = +1 ;
    _KnightMoveX [2] = +2 ;     _KnightMoveY [2] = -1 ;
    _KnightMoveX [3] = +1 ;     _KnightMoveY [3] = -2 ;
    _KnightMoveX [4] = -1 ;     _KnightMoveY [4] = -2 ;
    _KnightMoveX [5] = -2 ;     _KnightMoveY [5] = -1 ;
    _KnightMoveX [6] = -2 ;     _KnightMoveY [6] = +1 ;
    _KnightMoveX [7] = -1 ;     _KnightMoveY [7] = +2 ;

    _KingMoveX   [0] = +0 ;     _KingMoveY   [0] = +1 ;
    _KingMoveX   [1] = +1 ;     _KingMoveY   [1] = +1 ;
    _KingMoveX   [2] = +1 ;     _KingMoveY   [2] =  0 ;
    _KingMoveX   [3] = +1 ;     _KingMoveY   [3] = -1 ;
    _KingMoveX   [4] =  0 ;     _KingMoveY   [4] = -1 ;
    _KingMoveX   [5] = -1 ;     _KingMoveY   [5] = -1 ;
    _KingMoveX   [6] = -1 ;     _KingMoveY   [6] =  0 ;
    _KingMoveX   [7] = -1 ;     _KingMoveY   [7] = +1 ;
        ...
        case MOVE_NORMAL :
            if (nCapture == EMPTY_SQUARE)
                ...
                if (Game [nG].nGameType == GAMETYPE_CRAZYHOUSE)
                    ...
                    switch (nCP)
                        {
                        case WHITE_PAWN :   Game [nG].nBuffer [BLACK_PAWN  ]++ ; break ;
                        case WHITE_KNIGHT : Game [nG].nBuffer [BLACK_KNIGHT]++ ; break ;
                        case WHITE_BISHOP : Game [nG].nBuffer [BLACK_BISHOP]++ ; break ;
                        case WHITE_ROOK :   Game [nG].nBuffer [BLACK_ROOK  ]++ ; break ;
                        case WHITE_QUEEN :  Game [nG].nBuffer [BLACK_QUEEN ]++ ; break ;

                        case BLACK_PAWN :   Game [nG].nBuffer [WHITE_PAWN  ]++ ; break ;
                        case BLACK_KNIGHT : Game [nG].nBuffer [WHITE_KNIGHT]++ ; break ;
                        case BLACK_BISHOP : Game [nG].nBuffer [WHITE_BISHOP]++ ; break ;
                        case BLACK_ROOK :   Game [nG].nBuffer [WHITE_ROOK  ]++ ; break ;
                        case BLACK_QUEEN :  Game [nG].nBuffer [WHITE_QUEEN ]++ ; break ;
                        }
                    }
                else
                if (Game [nG].nGameType == GAMETYPE_FICS_ATOMIC)
                ...
                if (Game [nG].bChessGame)   // chess game buffer update
                    {
                    if (Game [nG].nPromoteBoard [nTX] [nTY])
                        {
                        switch (nCapture)
                    ...
                    switch (nCP)
                        {
                        case WHITE_PAWN :   Game [nG].nBuffer [WHITE_PAWN  ]++ ; break ;
                        case WHITE_KNIGHT : Game [nG].nBuffer [WHITE_KNIGHT]++ ; break ;
                        case WHITE_BISHOP : Game [nG].nBuffer [WHITE_BISHOP]++ ; break ;
                        case WHITE_ROOK :   Game [nG].nBuffer [WHITE_ROOK  ]++ ; break ;
                        case WHITE_QUEEN :  Game [nG].nBuffer [WHITE_QUEEN ]++ ; break ;

                        case BLACK_PAWN :   Game [nG].nBuffer [BLACK_PAWN  ]++ ; break ;
                        case BLACK_KNIGHT : Game [nG].nBuffer [BLACK_KNIGHT]++ ; break ;
                        case BLACK_BISHOP : Game [nG].nBuffer [BLACK_BISHOP]++ ; break ;
                        case BLACK_ROOK :   Game [nG].nBuffer [BLACK_ROOK  ]++ ; break ;
                        case BLACK_QUEEN :  Game [nG].nBuffer [BLACK_QUEEN ]++ ; break ;
                        }
                    }
                }
            ...
            if (Game [nG].nBoard [nTX] [nTY] == WHITE_ROOK)
                {
                if (nFX == 7 && nFY == 0)
                    {
                    Game [nG].bCanCastleKingSide [INDEX_WHITE] = 0 ;
            ...
            if (Game [nG].nBoard [nTX] [nTY] == BLACK_KING)
                {
            ...
            if (Game [nG].nBoard [nTX] [nTY] == BLACK_ROOK)
                {
                if (nFX == 7 && nFY == 7)
                    {
                    Game [nG].bCanCastleKingSide [INDEX_BLACK] = 0 ;
...
int CHESS_SmartMoveSource (int nG, int nX, int nY)
    ...
    if (Game [nG].nGameType == GAMETYPE_LOSER)
        ...
        if ((Game [nG].nGameType == GAMETYPE_SUICIDE ) ||
            ...
            if (nCC == 1)   // only one capture move
                {
                for (nI = 0 ; nI < TempMoves.nMove ; nI++)
                    {
                    if ((TempMoves.nCapture [nI] >= WHITE_PAWN) && (TempMoves.nCapture [nI] <= BLACK_KING))
