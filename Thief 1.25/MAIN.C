                    ...
                    if (*cEnd == NULL_CHAR)
                        ...
                        if (Timeseal.bBeforeLogin)
                            ...
                            switch (Login.nLoginType)
                                {
                                case SERVER_FICS :    FICS_ProcessBeforeLoginLine    (cStart) ; break ;
                                case SERVER_ICC :     ICC_ProcessBeforeLoginLine     (cStart) ; break ;
                                case SERVER_NONFICS : NONFICS_ProcessBeforeLoginLine (cStart) ; break ;
                                default :             NONFICS_ProcessBeforeLoginLine (cStart) ; break ;
                                }
                            }
                        else
                            {
                            switch (Login.nLoginType)
                                {
                                case SERVER_FICS :    FICS_ProcessLine    (cStart) ; break ;
                                case SERVER_ICC :     ICC_ProcessLine     (cStart) ; break ;
                                case SERVER_NONFICS : NONFICS_ProcessLine (cStart) ; break ;
                                default :             NONFICS_ProcessLine (cStart) ; break ;
                                }
                            }
                        break ;
                        }
                   ...
                   if (*cEnd == NULL_CHAR)
                    ...
                    if (Timeseal.bSocketLine)
                        ...
                        *cEnd = NULL_CHAR ;
                        ...
                        switch (Login.nLoginType)
                            {
                            case SERVER_FICS :    FICS_ProcessLine    (Timeseal.cSocketLine) ; break ;
                            case SERVER_ICC :     ICC_ProcessLine     (Timeseal.cSocketLine) ; break ;
                            case SERVER_NONFICS : NONFICS_ProcessLine (Timeseal.cSocketLine) ; break ;
                            default :             NONFICS_ProcessLine (Timeseal.cSocketLine) ; break ;
                            }
                        }
                    else
                        {
