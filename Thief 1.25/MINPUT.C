...
BOOL CALLBACK MoveInputBoxWndProc (HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
    ...
    switch (iMsg)
        ...
        case WM_INITDIALOG :
            ...
            if (User.nAnimateSpeedObserve >= MAX_ANIMATE_SPEED)
                {
            ...
            if (User.nAnimateSpeedExam >= MAX_ANIMATE_SPEED)
                {
            ...
            if (User.nAnimateSpeedPlay >= MAX_ANIMATE_SPEED)
                {
            ...
            switch (LOWORD (wParam))
                ...
                case IDOK :
                    ...
                    if (nI == CB_ERR)
                        ...
                        switch (nI)
                            {
                            case 0 :  User.nMoveType = DRAG_MOVE ;      break ;
                            case 1 :  User.nMoveType = CLICK_MOVE ;     break ;
                            case 2 :  User.nMoveType = INVISIBLE_MOVE ; break ;
                            default : User.nMoveType = DRAG_MOVE ;      break ;
                            }
                        }
